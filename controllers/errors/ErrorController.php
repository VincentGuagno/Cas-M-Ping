<?php
	...
	/*
	 * Error controller core
	 * This class is above all error classes
	 *
		...
		public function init() {
			...
			if(file_exists(_TWIG_AUTOLOADER_)) {
				try {
					...
					$loader = new Twig_Loader_Filesystem(array(_DEPENDENCIES_DIR_, _ERRORS_VIEWS_)); 
