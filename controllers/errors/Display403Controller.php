<?php
	...
	/*
	 * Controller for display 403 error page
	 * This class handles the 403 displays
	 *
	...
	class Display403Controller extends ErrorController {
		
		/**
		 * Name of called view
		 */
		private $view_name = '403';
		...
		public function init() {
			...
			if (file_exists (_CONTROLLERS_DIR_ .'/Tools.php')) {
				...
				if ($controller == 'Display403Controller') {
