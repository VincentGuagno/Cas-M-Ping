<?php
	...
	/*
	 * Controller for display 500 error page
	 * This class handles the 500 displays
	 *
	...
	class Display500Controller extends ErrorController {
		
		/**
		 * Name of called view
		 */
		private $view_name = '500';
		...
		public function init() {
			...
			if (file_exists (_CONTROLLERS_DIR_ .'/Tools.php')) {
				...
				if ($controller == 'Display500Controller') {
